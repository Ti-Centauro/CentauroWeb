...
export async function POST(req: Request)
{
  ...
  const result = streamText({
    ...
    system: `
      ...
      3. Se não encontrar a informação no contexto, diga: "Para essa informação específica, recomendo entrar em contato direto com nosso time comercial no telefone (21) 3176-7900."
